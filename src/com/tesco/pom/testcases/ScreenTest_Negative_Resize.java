...
public class ScreenTest_Negative_Resize extends BaseTest {
	
	String testCaseName="ScreenTest_Negative_Resize";
	...
	public void doLogin(Hashtable<String, String> data) throws InterruptedException
	{
		...
		try {
			...
			Target tg =null;
			tg = new ImageTarget(new File(System.getProperty("user.dir")+"\\Images\\Tesco_Grocery_Items_Negative.PNG"));
			r = srn.find(tg);
			
			Thread.sleep(5000);
			if( r!=null)
			{
				test.log(LogStatus.INFO,"Screenshot " +test.addScreenCapture(System.getProperty("user.dir")+"\\Images\\Tesco_Grocery_Items_Negative.PNG"));
