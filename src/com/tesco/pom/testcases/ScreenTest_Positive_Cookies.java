...
public class ScreenTest_Positive_Cookies extends BaseTest {
	String testCaseName="ScreenTest_Positive_Cookies";
	...
	public void doLogin(Hashtable<String, String> data) throws InterruptedException
	{
		...
		try {
			...
			Target tg =null;
			tg = new ImageTarget(new File(System.getProperty("user.dir")+"\\Images\\Tesco_Cookies_Positive.PNG"));
			r = srn.find(tg);
			
			Thread.sleep(5000);
			if( r!=null)
			{
				test.log(LogStatus.INFO,"Screenshot " +test.addScreenCapture(System.getProperty("user.dir")+"\\Images\\Tesco_Cookies_Positive.PNG"));
				reportPass("Privacy policy and cookies Resolution appropriate");
